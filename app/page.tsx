    ...
    <main className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
      <div className="mt-10">
        ...
        <div className="bg-white min-h-full rounded-2xl mt-7 mb-10">
            <h1 className="text-3xl mt-3 py-5 px-5 font-bold text-blue-600">👨🏻‍💻 Profesional Experience</h1>
            <div className="hero-content mt-[-1.1rem] flex-row flex-wrap">
                <div className="card w-96 h-80 bg-base-100 shadow-2xl">
                    <figure className="px-10 pt-10">
                        <img src="mp.png" alt="medikaplaza"
                            className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center text-center">
                        <h2 className="text-sm card-title">PT. kartika Bina Medikatama</h2>
                        <p className="text-xs">Experienced developer in MAS, E-Commerce, CRM, POS, and more. Created HRIS, Chat Bot, Covid-19 App, and warehouse systems. </p>
            
                    </div>
                </div>
                <div className="card w-96 h-80 bg-base-100 shadow-2xl">
                    <figure className="px-10 pt-10">
                        <img src="ptcs.png" alt="ptcs"
                            className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center text-center">
                        <h2 className="text-sm card-title">PT. Control System Arena Para Nusa</h2>
                        <p className="text-xs">Responsibility is to design and implement systems while collaborating with cross-functional teams to develop and launch new products and features. </p>
        ...
        <div className="bg-white rounded-2xl mt-7 mb-10">
            <h1 className="text-3xl mt-3 py-5 px-5 font-bold text-blue-600">📈 Project Experience</h1>
                ...
                <ul className="bg-white rounded-2xl container mx-auto divide-y divide-gray-400 divide-dotted">          
                    <li className="flex items-center justify-between px-4 py-2">
                      <div className="antialiased">
                        <div className="font-bold text-2xl align-middle mb-2">💻 Medical Administration System</div>      
                          <ul className="list-inside list-disc">
                            <li>Manage Claims System</li>
                            <li>Manage EDC Service for All Provider in Indonesia user </li>
                            <li>Medlinx Services for Integration</li>
                            <li className="font-bold">Manage Support App Use PHP native for:</li>
                      ...
                      <div className="text-xs font-semibold font-mono whitespace-nowrap px-2 py-1 ml-5 rounded text-white bg-pink-500 rounded-2">🏢 PT Kartika Bina Medikatama</div>
                    </li>
                    <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 Medical Administration System v2 [Use PHP Framework Yii 2]</div>      
                            <ul className="list-inside list-disc">
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 File Receipt System</div>      
                            <ul className="list-inside list-disc">
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 Medical Assistance</div>      
                            <ul className="list-inside list-disc">
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 MP Core</div>      
                            <ul className="list-inside list-disc">
                              <li>Warehouse Asset Management System Integration 
                                with Item SAP</li>
                              <li>Warehouse Alat Kesehatan Asset Management 
                                System Integration with SAP system
                                </li>
                              <li>Stock Opname System Integration Data (View) with 
                                SAP system</li>
                              <li>Courier Application System with Notification to 
                                WhatsApp Group</li>
                            </ul>
                        </div>
                        <div className="text-xs font-semibold font-mono whitespace-nowrap px-2 py-1 ml-5 rounded text-white bg-pink-500 rounded-2">🏢 PT Kartika Bina Medikatama</div>
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 Covid 19 Application</div>      
                            <ul className="list-inside list-disc">
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 Dashboard Monitoring SAP</div>      
                            <ul className="list-inside list-disc">
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 HRIS System</div>      
                            <ul className="list-inside list-disc">
                              <li>HRIS system for company integration with payroll system</li>
                            </ul>
                        </div>
                        <div className="text-xs font-semibold font-mono whitespace-nowrap px-2 py-1 ml-5 rounded text-white bg-pink-500 rounded-2">🏢 PT Kartika Bina Medikatama</div>
                      </li>
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 DO Tracking (Using Odoo)</div>      
                            <ul className="list-inside list-disc">
                      ...
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 FilesSharing for External user Pertamina 
                            PHONWJ</div>      
                            <ul className="list-inside list-disc">
                              <li>Create a System for Client to Sharing file between Client. 
                                Using AWS and S3</li>
                            </ul>
                        </div>
                        <div className="text-xs font-semibold font-mono whitespace-nowrap px-2 py-1 ml-5 rounded text-white bg-pink-500 rounded-2">🏢 PT Control System Arena Paranusa</div>
                      </li>
                      <li className="flex items-center justify-between px-4 py-2">
                        <div className="antialiased">
                          <div className="font-bold text-2xl align-middle mb-2">💻 Contract Management</div>      
                            <ul className="list-inside list-disc">
                              <li>Create Contrack management for FCLCS Dept to Manage Contract and Budget from Client and Dashboard for Client</li>
                            </ul>
                        </div>
                        <div className="text-xs font-semibold font-mono whitespace-nowrap px-2 py-1 ml-5 rounded text-white bg-pink-500 rounded-2">🏢 PT Control System Arena Paranusa</div>
                      </li>
